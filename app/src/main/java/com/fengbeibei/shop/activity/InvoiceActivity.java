...
import com.fengbeibei.shop.adapter.InvoiceAdapter;
...
public class InvoiceActivity extends BaseActivity implements AdapterView.OnItemSelectedListener,OnInvoiceDeleteListener,AdapterView.OnItemClickListener {
    public static final int RESULT_INVOICE = 0x4;
    public static final int RESULT_INVOICE_NO_INVOICE = -1;
        ...
        switch (v.getId()){
            ...
            case R.id.btn_confirm:
                if(mOpenInvoiceView.isSelected() && mShowInvoiceSetting.isChecked()){
                    ...
                    setResult(RESULT_INVOICE_NO_INVOICE);
                    finish();
                }
                break;
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        setResult(RESULT_INVOICE, intent);
        finish();
    }
