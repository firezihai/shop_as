...
import com.zihai.shop.callback.AddrAddAreaSelectedListener;
...
public class AddressAddFragment extends BaseFragment implements View.OnClickListener{
    ...
    public static void selectedAreaCallback(AddressAddFragment fragment,com.zihai.shop.common.Address address){
