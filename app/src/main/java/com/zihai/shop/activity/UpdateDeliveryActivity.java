...
import com.zihai.shop.callback.DeliveryAreaSelectedListener;
...
public class UpdateDeliveryActivity extends BaseActivity{
    ...
    public static void onAreaSelected(UpdateDeliveryActivity activity,com.zihai.shop.common.Address address) {
